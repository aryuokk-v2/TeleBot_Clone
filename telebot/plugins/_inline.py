...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
        ...
        if event.query.user_id == bot.uid and query.startswith("`Userbot"):
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("Repo", "https://github.com/arupmandal/TeleBot")],
                    [
                        Button.url(
                            "Deploy Now!",
            ...
            result = builder.article(
                ...
                buttons=[
                    [
                        ...
                        Button.url(
                            "Deploy",
                            "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Farupmandal%2FTeleBot&template=https%3A%2F%2Fgithub.com%2Farupmandal%2FTeleBot",
                        ),
                    ],
                    [Button.url("Support", "https://t.me/arupbotsofficial")],
                ],
            )
        else:
            result = builder.article(
                ...
                buttons=[
                    [custom.Button.url("Creator👨‍🦱", "https://t.me/iamarupmandal")],
                    [
                        custom.Button.url(
                            "👨‍💻Source Code‍💻", "https://github.com/arupmandal/TeleBot"
                        ),
                        custom.Button.url(
                            "Deploy 🌀",
                            "https://dashboard.heroku.com/new?template=https%3A%2F%2Fgithub.com%2Farupmandal%2FTeleBot",
                        ),
                    ],
                    [
                        custom.Button.url(
                            "Updates and Support Group↗️",
                            "https://t.me/arupbotsofficial",
                        )
                    ],
                ],
                link_preview=False,
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "Please get your own userbot from @iamarupmandal "
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
