    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      [Button.url(
                                          "TeleBot", url="https://github.com/arupmandal/TeleBot")],
                                      [Button.inline(
...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        buttons=[
            ...
            [Button.url("Crashed?", "t.me/arupbotsofficial")]
        ])
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com/arupmandal/TeleBot")),
                          (Button.url("Deploy", url="https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Farupmandal%2FTeleBot%2F&template=https%3A%2F%2Fgithub.com%2Farupmandal%2FTeleBot"))],
                         [Button.url("Support",
                                     url="https://t.me/iamarupmandal")]
                     ])
